...
import Zoom from 'react-native-img-zoom';
import styles from './viewer.style';
import { IImageInfo, IImageSize, Props, State } from './viewer.type';
...
export default class ImageViewer extends React.Component<Props, State> {
  ...
  public init(nextProps: Props) {
    ...
    nextProps.imageUrls.forEach((imageUrl: any) => {
      imageSizes.push({
  ...
  public getContent() {
    ...
    const ImageElements = this.props.imageUrls.map((image: any, index: any) => {
